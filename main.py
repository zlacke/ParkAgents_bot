...
ADS = {
    "taxopark": {
        ...
        "text": (
            "🚖 Таксопарк 369: Аренда авто от Эконома до Комфорт+\n"
            ...
            "✅ Наши машины ВСЕ ЗАСТРАХОВАНЫ!\n"
            "🎁 Гостевой доступ — протестируй перед стартом!\n"
            
        ),
        "keyboard": [[InlineKeyboardButton("📲 Подключиться", url="https://t.me/ElisavetaZ369")]]
    },
    "work_official": {
    ...
    "park_connection": {
        ...
        "keyboard": [[InlineKeyboardButton("📲 Хочу подключиться", url="https://t.me/zp_help")]]
    },
    "waybill": {
